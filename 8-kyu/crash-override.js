...
function aliasGen(primaryName, lastName) {
    ...
    if (initialLetterOfFirstNameCharCode < upperCaseLetterCharCodeRangeStart || initialLetterOfFirstNameCharCode > upperCaseLetterCharCodeRangeEnd ||
        initialLetterOfLastNameCharCode < upperCaseLetterCharCodeRangeStart || initialLetterOfLastNameCharCode > upperCaseLetterCharCodeRangeEnd) {
