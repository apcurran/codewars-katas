...
function hasSurvived(attackers, defenders) {
    ...
    if (defendingSurvivorsCount === attackingSurvivorsCount) {
        ...
        const attackersTotalDamage = attackers.reduce((total, currentValue) => total + currentValue, 0);
        const defendersTotalDamage = defenders.reduce((total, currentValue) => total + currentValue, 0);
